...
const pageTitle = "Utilities";
const pageDescription = "Free mini apps and calculators for Kenya payroll, finance planning, and everyday product decisions.";
const pagePath = "/utilities";
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {utilities.map(({ title, description, href, icon: Icon }) => (
                <Link
                  key={title}
                  href={href}
                  className="panel block p-4 transition-colors hover:border-slate-300 hover:bg-white"
                >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-slate-600">
                    This hub is ready for additional mini apps such as loan amortization, VAT, currency
                    planning, and project estimators.
                  </p>
                </div>
              </div>
            </div>
